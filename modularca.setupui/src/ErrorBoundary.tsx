...
/**
 * Top-level React error boundary for the setup wizard. The
 * shown message is intentionally generic — raw error.message strings may
 * include backend type names or paths from ASP.NET ProblemDetails.
 */
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
    ...
    componentDidCatch(_error: Error, _info: React.ErrorInfo): void {
        // Backend logging endpoint not yet implemented.
    }
                ...
                <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-6">
                    <div className="max-w-md w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-8 text-center">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                            The setup wizard encountered an unexpected error. Reload to start over.
                        </p>
                        <button
                            type="button"
