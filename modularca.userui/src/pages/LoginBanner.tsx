...
/// <summary>
/// Pre-login banner gate for the user portal. Mirrors adminui/LoginBanner.
/// Fetches /auth/login-banner, shows title + body + Accept/Decline, and sets
/// a sessionStorage flag on accept so Login.tsx lets the user through.
/// </summary>
